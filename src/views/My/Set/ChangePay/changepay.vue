<template>
	<div class="pay-page">
		...
		<div class="info">
			...
			<van-cell-group inset class="grouppass">
				<van-field v-model="pay" placeholder="请输入旧支付密码" maxlength="12" />
			</van-cell-group>
			<van-cell-group inset class="grouppass">
				<van-field v-model="newpay" placeholder="请输入新支付密码" maxlength="12" />
			</van-cell-group>
			<van-cell-group inset class="grouppass">
				<van-field v-model="qerpay" placeholder="请再次输入新支付密码" maxlength="12" />
			</van-cell-group>
...
<style>
	#app .pay-page .van-nav-bar {
		background-color: rgba(0, 0, 0, 0.0);
	}

	#app .pay-page .van-nav-bar__title {
		color: #fff;
	}

	#app .pay-page .van-nav-bar .van-icon {
		color: #fff;
	}
	#app .pay-page .register-btn .van-button{
		height: 40px;
		border-radius: 8px;
	}
	:root {
